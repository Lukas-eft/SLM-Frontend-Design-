...
export const BentoCard = ({ title, description, visual, className = "", children }) => {
  return (
    <div className={`p-8 rounded-3xl bg-[#0A0A0A] border border-white/10 flex flex-col gap-6 group hover:border-white/20 transition-all duration-500 hover:shadow-[0_0_40px_rgba(255,255,255,0.03)] relative overflow-hidden ${className}`}>
      <div className="absolute inset-0 bg-[radial-gradient(#ffffff03_1px,transparent_1px)] bg-size-[20px_20px] opacity-50 group-hover:opacity-100 transition-opacity" />
